module.exports = function(grunt) {
    grunt.initConfig({
        ...
        postcss: {options: {processors: [require("autoprefixer")({browsers: "last 2 versions"})]}, main: {src: "dist/animadio.css"}, box: {src: "dist/animadio-box.css"}, grid: {src: "dist/animadio-grid.css"}, elements: {src: "dist/animadio-elements.css"}, states: {src: "dist/animadio-states.css"}}, helpers: {src: "dist/animadio-helpers.css"},
        cssmin: {target: {files: [{"dist/min/animadio.min.css": ["dist/animadio.css"]}, {"dist/min/animadio-box.min.css": ["dist/animadio-box.css"]}, {"dist/min/animadio-grid.min.css": ["dist/animadio-grid.css"]}, {"dist/min/animadio-elements.min.css": ["dist/animadio-elements.css"]}, {"dist/min/animadio-states.min.css": ["dist/animadio-states.css"]}, {"dist/min/animadio-helpers.min.css": ["dist/animadio-helpers.css"]}]}}
    });
